  ...
  deleteCart: function () {
    ...
    util.request(api.CartDelete, {
      ...
      if (res.errno === 0) {
        ...
        // const goodsAmount = res.data.cartTotal.goodsAmount;
        // const checkedGoodsAmount = res.data.cartTotal.checkedGoodsAmount;
        // res.data.cartTotal.goodsAmount = res.data.cartTotal.goodsAmount.toFixed(2);
        // res.data.cartTotal.checkedGoodsAmount = res.data.cartTotal.checkedGoodsAmount.toFixed(2);
        that.setData({
          cartGoods: cartList,
          cartTotal: res.data.cartTotal
        });
